namespace :uba_2024_import do
  ...
  task guinea_answers: :environment do
    require "roo"
    require "pp"

    file_path = "db/seeds/uba_2024_data/UBA_guinea_2024_workpaper.xlsx"
    ...
    assessment = Assessment.where(assessment_batch_id: 2, team_id: 12).first
