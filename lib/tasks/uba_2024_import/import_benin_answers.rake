namespace :uba_2024_import do
  ...
  task benin_answers: :environment do
    require "roo"
    require "pp"

    file_path = "db/seeds/uba_2024_data/UBA_benin_2024_workpaper.xlsx"
    ...
    assessment = Assessment.where(assessment_batch_id: 2, team_id: 5).first
    ...
    ActiveRecord::Base.transaction do
      ...
      (2..xlsx.last_row).each do |row_index|
        ...
        raise "Missing response at row #{row_index}" if response.blank?
