namespace :uba_2024_import do
  ...
  task ghana_answers: :environment do
    require "roo"
    require "pp"

    file_path = "db/seeds/uba_2024_data/UBA_ghana_2024_workpaper.xlsx"
    ...
    # Replace team_id for each subsidiary
    assessment = Assessment.where(assessment_batch_id: 2, team_id: 6).first
